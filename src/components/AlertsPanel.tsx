import { geofenceAlerts, vehicles } from '@/data/mockData';
    ...
    <div className="h-full flex flex-col">
      <div className="p-4 border-b border-border flex items-center justify-between">
        <div>
          ...
          <h3 className="font-semibold tracking-tight">{geofenceAlerts.length} Events</h3>
        </div>
              ...
              <div className="flex items-start gap-2">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="font-mono-data text-[10px] text-muted-foreground mt-0.5">
                    {alert.coordinates.lat.toFixed(3)}° N, {Math.abs(alert.coordinates.lng).toFixed(3)}° W
                  </p>
                </div>
              </div>
            </motion.div>
